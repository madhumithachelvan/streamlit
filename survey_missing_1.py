...
def page1():
    ...
    st.markdown(
        ...
        <p class="custom-text">Your participation will take an estimated 20 minutes. The time required may vary on an individual basis </p>
...
def page5():
    ...
    st.markdown(
        """ 
        <p class="custom-text">
        There are 30 short texts (posts) provided in the following pages, which will take an estimated 15 minutes to complete. For each text (post), please provide your perception on the writing style -- masculine/feminine/neutral.
        </p>
...
@st.cache_data
def load_data():
    return pd.read_csv("data_pilot1_attention.csv")
